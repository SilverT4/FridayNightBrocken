...
/**This allows you to set a character as a favourite to appear in the BF category.
@since March 2022 (Emo Engine 0.1.2)*/
class FavBFChar extends MusicBeatSubstate {
    ...
    public function new() {
        ...
        curList = yourFavs.favouriteChars.bf;
        newList = curList;
    ...
    function saveChanges() {
        yourFavs.favouriteChars.bf = newList;
