...
/**This allows you to set a character as a favourite to appear in the opponent category.
@since March 2022 (Emo Engine 0.1.2)*/
class FavOpponChar extends MusicBeatSubstate {
    ...
    public function new() {
        ...
        curList = yourFavs.favouriteChars.opponent;
        newList = curList;
    ...
    function saveChanges() {
        yourFavs.favouriteChars.opponent = newList;
