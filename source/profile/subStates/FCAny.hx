...
/**This allows you to set a character as a favourite to appear in *all* character categories.
@since March 2022 (Emo Engine 0.1.2)*/
class FCAny extends MusicBeatSubstate {
    ...
    public function new() {
        ...
        curList = yourFavs.favouriteChars.any;
        newList = curList;
    ...
    function saveChanges() {
        yourFavs.favouriteChars.any = newList;
