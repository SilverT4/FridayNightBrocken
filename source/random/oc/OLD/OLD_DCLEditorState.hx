...
import random.oc.old.OLD_PronounManager;
...
class DCLEditorState extends MusicBeatState {
    ...
    function generateUIPronouns() {
        ...
        pronounEditButton = new FlxButton(240, 480, 'Edit', function() {
            ...
            random.oc.old.OLD_PronounManager.PronounManager.addPrnsToList(OC.characterPronouns);
            openSubState(new random.oc.old.OLD_PronounManager.PronounManager(OC.characterPronouns));
        });
